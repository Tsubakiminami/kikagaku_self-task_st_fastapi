...
This app.py code starts now. global_flag= False 2024-01-02 15:09:24.721082
'''
...
global_flag = False
print('This app.py code starts now. global_flag=', global_flag, datetime.now())
...
st.sidebar.write('V1.00 R6(2024)/01/02')
    # V0.01 R5(2023)/12/02 
    # V0.02 R5(2023)/12/03 
    # V0.03 R5(2023)/12/06)
    # V0.04 R5(2023)/12/07
...
def main():
    ...
    if uploaded_file_sample is not None:
        ...
        print('  uploaded_サンプル画像ファイル名：',uploaded_file_sample, datetime.now())
    ...
    if uploaded_file is not None:
        print('  uploaded_選択画像ファイル名：',uploaded_file, datetime.now())
...
print('This app.py code ends. global_flag=', global_flag, datetime.now())
print('\n')
