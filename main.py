...
print('This main.py code for FastAPI starts.',  datetime.now())
...
async def process_image_prediction(file: UploadFile = File(...)):
    ...
    print(f'　予測結果 on FastAPI： {prediction}', 'current time:', datetime.now())
...
print("This main.py code for FastAPI ends.", datetime.now())